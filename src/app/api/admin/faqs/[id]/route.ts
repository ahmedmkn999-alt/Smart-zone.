...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  await writeAuditLog({ actorType: "admin", adminId: admin.sub, action: "FAQ_UPDATE", targetType: "Faq", targetId: faq.id });
...
export async function DELETE(_req: NextRequest, { params }: { params: { id: string } }) {
  ...
  await writeAuditLog({ actorType: "admin", adminId: admin.sub, action: "FAQ_DELETE", targetType: "Faq", targetId: params.id });
